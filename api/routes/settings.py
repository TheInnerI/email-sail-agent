...
async def get_settings(request: Request):
    ...
    return {
        ...
        "business_info": row["business_info"] or "",
    ...
    if existing:
        await db.execute(
            """UPDATE user_settings SET
               ...
               tier = ?, preferred_model = ?, business_info = ?,
               signature = ?,
            ...
            (
                ...
                body.get("tier", "free"),
                body.get("preferred_model", ""),
                body.get("business_info", ""),
                body.get("signature", ""),
        ...
        await db.execute(
            """INSERT INTO user_settings
               (user_id, twilio_sid, twilio_auth_token, twilio_phone,
                ...
                fh_auto_respond_faq, fh_auto_request_reviews,
                fh_review_delay_days, fh_no_show_followup,
                tier, preferred_model, business_info, signature,
